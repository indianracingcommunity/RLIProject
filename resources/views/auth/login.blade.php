...
<div class="container mx-auto">
    ...
    <div class="px-3 bg-gray-800 mx-2 text-center text-white font-bold rounded-md hover:bg-gray-700 cursor-pointer flex items-center flex-shrink-0">
            <a href="/" class="flex ml-10 px-2 bg-gray-800 mx-2 text-white font-bold rounded-md hover:bg-gray-700"><img src="/img/IRC_logo/logo_square.png" class="h-10 mt-1"> <span class="p-3">Indian Racing Comunity</span> </a>
    </div>
