...
<div class="flex-column md:flex items-center w-full">
	<div class="inline-block text-center w-full">
		...
		<div class="flex-column md:flex bg-gray-100 justify-center">
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(2,$fieldsTeams) ) href="/user/profile/view/2" @endif><img src="@if( array_key_exists(2,$fieldsTeams) && $fieldsTeams[2]['avatar'] != null) {{$fieldsTeams[2]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(27,$fieldsTeams)) href="/user/profile/view/27" @endif><img src="@if( array_key_exists(27,$fieldsTeams) && $fieldsTeams['27']['avatar'] != null) {{$fieldsTeams[27]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-green-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(95,$fieldsTeams)) href="/user/profile/view/95" @endif><img src="@if( array_key_exists(95,$fieldsTeams) && $fieldsTeams[95]['avatar'] != null) {{$fieldsTeams[95]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-purple-400 justify-center">
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(17,$fieldsTeams)) href="/user/profile/view/17" @endif><img src="@if( array_key_exists(17,$fieldsTeams) && $fieldsTeams[17]['avatar'] != null) {{$fieldsTeams[17]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-pink-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(1,$fieldsTeams)) href="/user/profile/view/1" @endif><img src="@if( array_key_exists(1,$fieldsTeams) && $fieldsTeams[1]['avatar'] != null) {{$fieldsTeams[1]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">CH Coordinator</br><span class="font-semibold text-gray-900"> Freeman</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(32,$fieldsTeams)) href="/user/profile/view/32" @endif><img src="@if( array_key_exists(32,$fieldsTeams) && $fieldsTeams[32]['avatar'] != null) {{$fieldsTeams[32]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-teal-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(64,$fieldsTeams)) href="/user/profile/view/64" @endif><img src="@if( array_key_exists(64,$fieldsTeams) && $fieldsTeams[64]['avatar'] != null) {{$fieldsTeams[64]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-orange-400 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(21,$fieldsTeams)) href="/user/profile/view/21" @endif><img src="@if( array_key_exists(21,$fieldsTeams) && $fieldsTeams['21']['avatar'] != null) {{$fieldsTeams[21]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
				<div class="font-bold mb-2 text-gray-700">Editor-in-Chief</br><span class="font-semibold text-gray-900"> NinjaZero</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(72,$fieldsTeams)) href="/user/profile/view/72" @endif><img src="@if( array_key_exists(72,$fieldsTeams) && $fieldsTeams['72']['avatar'] != null) {{$fieldsTeams[72]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(33,$fieldsTeams)) href="/user/profile/view/33" @endif><img src="@if( array_key_exists(33,$fieldsTeams) && $fieldsTeams['33']['avatar'] != null) {{$fieldsTeams[33]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(13,$fieldsTeams)) href="/user/profile/view/13" @endif><img src="@if( array_key_exists(13,$fieldsTeams) && $fieldsTeams[13]['avatar'] != null) {{$fieldsTeams[13]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(110,$fieldsTeams)) href="/user/profile/view/110" @endif><img src="@if( array_key_exists(110,$fieldsTeams) && $fieldsTeams[110]['avatar'] != null) {{$fieldsTeams[110]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
				<div class="font-bold mb-2 text-gray-700">Member of Editorial</br><span class="font-semibold text-gray-900"> Sai_Tarun</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(122,$fieldsTeams)) href="/user/profile/view/122" @endif><img src="@if( array_key_exists(122,$fieldsTeams) && $fieldsTeams[122]['avatar'] != null) {{$fieldsTeams[122]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
				<div class="font-bold mb-2 text-gray-700">Member of Editorial</br><span class="font-semibold text-gray-900"> Nervii</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(31,$fieldsTeams)) href="/user/profile/view/31" @endif><img src="@if( array_key_exists(31,$fieldsTeams) && $fieldsTeams[31]['avatar'] != null) {{$fieldsTeams[31]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-purple-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(75,$fieldsTeams)) href="/user/profile/view/75" @endif><img src="@if( array_key_exists(75,$fieldsTeams) && $fieldsTeams[75]['avatar'] != null) {{$fieldsTeams[75]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(100,$fieldsTeams)) href="/user/profile/view/100" @endif><img src="@if( array_key_exists(100,$fieldsTeams) && $fieldsTeams[100]['avatar'] != null) {{$fieldsTeams[100]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-yellow-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(9,$fieldsTeams)) href="/user/profile/view/9" @endif><img src="@if( array_key_exists(9,$fieldsTeams) && $fieldsTeams[9]['avatar'] != null) {{$fieldsTeams[9]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Reddit</br><span class="font-semibold text-gray-900"> Oxygen</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(111,$fieldsTeams)) href="/user/profile/view/111" @endif><img src="@if( array_key_exists(111,$fieldsTeams) && $fieldsTeams[111]['avatar'] != null) {{$fieldsTeams[111]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
		...
		<div class="flex-column md:flex bg-blue-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex-column md:flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(164,$fieldsTeams)) href="/user/profile/view/164" @endif><img src="@if( array_key_exists(164,$fieldsTeams) && $fieldsTeams[164]['avatar'] != null) {{$fieldsTeams[164]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain mx-auto"></a>
				</div>
