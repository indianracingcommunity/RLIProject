...
<div class="flex items-center w-full">
	<div class="inline-block text-center w-full">
		...
		<div class="flex bg-gray-100 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(101,$fieldsTeams)) href="/user/profile/view/101" @endif><img src="@if( array_key_exists(101,$fieldsTeams) && $fieldsTeams[101]['avatar'] != null) {{$fieldsTeams[101]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-800">Aditya "GryphuS" Jain</div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(27,$fieldsTeams)) href="/user/profile/view/27" @endif><img src="@if( array_key_exists(27,$fieldsTeams) && $fieldsTeams['27']['avatar'] != null) {{$fieldsTeams[27]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-800">Subham "The-Real-SD" Das</div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(16,$fieldsTeams)) href="/user/profile/view/16" @endif><img src="@if( array_key_exists(16,$fieldsTeams) && $fieldsTeams[16]['avatar'] != null) {{$fieldsTeams[16]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-purple-400 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(17,$fieldsTeams)) href="/user/profile/view/17" @endif><img src="@if( array_key_exists(17,$fieldsTeams) && $fieldsTeams[17]['avatar'] != null) {{$fieldsTeams[17]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-pink-300 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(12,$fieldsTeams)) href="/user/profile/view/12" @endif><img src="@if( array_key_exists(12,$fieldsTeams) && $fieldsTeams[12]['avatar'] != null) {{$fieldsTeams[12]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Tier-1 Coordinator</br><span class="font-semibold text-gray-900"> 5zan</span></div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(7,$fieldsTeams)) href="/user/profile/view/7" @endif><img src="@if( array_key_exists(7,$fieldsTeams) && $fieldsTeams[7]['avatar'] != null) {{$fieldsTeams[7]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Tier-1 Coordinator</br><span class="font-semibold text-gray-900"> Streeter</span></div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(34,$fieldsTeams)) href="/user/profile/view/34" @endif><img src="@if( array_key_exists(34,$fieldsTeams) && $fieldsTeams[34]['avatar'] != null) {{$fieldsTeams[34]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(1,$fieldsTeams)) href="/user/profile/view/1" @endif><img src="@if( array_key_exists(1,$fieldsTeams) && $fieldsTeams[1]['avatar'] != null) {{$fieldsTeams[1]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Tier-2 Coordinator</br><span class="font-semibold text-gray-900"> Freeman</span></div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(32,$fieldsTeams)) href="/user/profile/view/32" @endif><img src="@if( array_key_exists(32,$fieldsTeams) && $fieldsTeams[32]['avatar'] != null) {{$fieldsTeams[32]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Tier-2 Coordinator</br><span class="font-semibold text-gray-900"> no more pp</span></div>
			</div>
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(45,$fieldsTeams)) href="/user/profile/view/45" @endif><img src="@if( array_key_exists(45,$fieldsTeams) && $fieldsTeams[45]['avatar'] != null) {{$fieldsTeams[45]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-teal-300 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(64,$fieldsTeams)) href="/user/profile/view/64" @endif><img src="@if( array_key_exists(64,$fieldsTeams) && $fieldsTeams[64]['avatar'] != null) {{$fieldsTeams[64]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-orange-400 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(21,$fieldsTeams)) href="/user/profile/view/21" @endif><img src="@if( array_key_exists(21,$fieldsTeams) && $fieldsTeams['21']['avatar'] != null) {{$fieldsTeams[21]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(33,$fieldsTeams)) href="/user/profile/view/33" @endif><img src="@if( array_key_exists(33,$fieldsTeams) && $fieldsTeams['33']['avatar'] != null) {{$fieldsTeams[33]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(13,$fieldsTeams)) href="/user/profile/view/13" @endif><img src="@if( array_key_exists(13,$fieldsTeams) && $fieldsTeams[13]['avatar'] != null) {{$fieldsTeams[13]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-purple-300 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(100,$fieldsTeams)) href="/user/profile/view/100" @endif><img src="@if( array_key_exists(100,$fieldsTeams) && $fieldsTeams[100]['avatar'] != null) {{$fieldsTeams[100]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-yellow-300 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(9,$fieldsTeams)) href="/user/profile/view/9" @endif><img src="@if( array_key_exists(9,$fieldsTeams) && $fieldsTeams[9]['avatar'] != null) {{$fieldsTeams[9]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
		...
		<div class="flex bg-blue-300 justify-center">
			...
			<div class="text-center p-4" style="text-align: -webkit-center;">
				<div class="rounded m-5 overflow-hidden text-center" style="width: 80px;">
					<a @if(array_key_exists(31,$fieldsTeams)) href="/user/profile/view/31" @endif><img src="@if( array_key_exists(31,$fieldsTeams) && $fieldsTeams[31]['avatar'] != null) {{$fieldsTeams[31]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2"></a>
				</div>
