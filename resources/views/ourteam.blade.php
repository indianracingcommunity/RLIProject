...
<div class="flex items-center w-full">
	<div class="inline-block text-center w-full">
		<div class="bg-gray-800 p-10 text-white justify-center font-bold rounded-md flex items-center flex-shrink-0">
			<img src="/img/IRC_logo/logo_square.png" class="h-10 mt-1"> <span class="py-3 pl-2 text-2xl">Indian Racing Community Team</span>
		</div>
		...
		<div class="flex bg-green-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-700">Kapil "kapilace6" Bharath</div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(27,$fieldsTeams)) href="/user/profile/view/27" @endif><img src="@if( array_key_exists(27,$fieldsTeams) && $fieldsTeams['27']['avatar'] != null) {{$fieldsTeams[27]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
		...
		<div class="flex bg-pink-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-600">Tier-1 Coordinator</br><span class="font-semibold text-gray-900"> notsomahsoom</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-600">Tier-2 Coordinator</br><span class="font-semibold text-gray-900"> Tanish</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
		...
		<div class="flex bg-teal-300 justify-center">
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-600">Head of Website Dev</br><span class="font-semibold text-gray-900"> Freeman</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(16,$fieldsTeams)) href="/user/profile/view/16" @endif><img src="@if( array_key_exists(16,$fieldsTeams) && $fieldsTeams[16]['avatar'] != null) {{$fieldsTeams[16]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Team Member</br><span class="font-semibold text-gray-900"> kapilace6</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(32,$fieldsTeams)) href="/user/profile/view/32" @endif><img src="@if( array_key_exists(32,$fieldsTeams) && $fieldsTeams[32]['avatar'] != null) {{$fieldsTeams[32]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
		...
		<div class="flex bg-purple-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(105,$fieldsTeams)) href="/user/profile/view/105" @endif><img src="@if( array_key_exists(105,$fieldsTeams) && $fieldsTeams['105']['avatar'] != null) {{$fieldsTeams[105]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
				</div>
				<div class="font-bold mb-2 text-gray-700">Streaming Member</br><span class="font-semibold text-gray-900"> harryrox24</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(16,$fieldsTeams)) href="/user/profile/view/16" @endif><img src="@if( array_key_exists(16,$fieldsTeams) && $fieldsTeams[16]['avatar'] != null) {{$fieldsTeams[16]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
		...
		<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(28,$fieldsTeams)) href="/user/profile/view/28" @endif><img src="@if( array_key_exists(28,$fieldsTeams) && $fieldsTeams[28]['avatar'] != null) {{$fieldsTeams[28]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Instagram</br><span class="font-semibold text-gray-900"> chalelerc</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(101,$fieldsTeams)) href="/user/profile/view/101" @endif><img src="@if( array_key_exists(101,$fieldsTeams) && $fieldsTeams[101]['avatar'] != null) {{$fieldsTeams[101]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
				</div>
				<div class="font-bold mb-2 text-gray-600">Steam</br><span class="font-semibold text-gray-900"> GryphuS</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(2,$fieldsTeams)) href="/user/profile/view/2" @endif><img src="@if( array_key_exists(2,$fieldsTeams) && $fieldsTeams[2]['avatar'] != null) {{$fieldsTeams[2]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-700">Twitter</br><span class="font-semibold text-gray-900"> Baba.G</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
				...
				<div class="font-bold mb-2 text-gray-600">Twitter</br><span class="font-semibold text-gray-900"> Modo</span></div>
			</div>
		</div>
		...
		<div class="flex bg-blue-300 justify-center">
			...
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				...
				<div class="font-bold mb-2 text-gray-700">Podcast Member</br><span class="font-semibold text-gray-900"> notsomahsoom</span></div>
			</div>
			<div class="block align-center text-center p-4" style="text-align: -webkit-center;">
				<div class="flex justify-center rounded overflow-hidden text-center w-full py-5">
					<a @if(array_key_exists(16,$fieldsTeams)) href="/user/profile/view/16" @endif><img src="@if( array_key_exists(16,$fieldsTeams) && $fieldsTeams[16]['avatar'] != null) {{$fieldsTeams[16]['avatar']}} @else {{asset('img/avatars/blankpic.png')}} @endif" class="rounded-full border-green-300 border-2 w-20 object-contain"></a>
