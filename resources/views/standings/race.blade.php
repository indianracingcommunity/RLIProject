    ...
    <div class="font-semibold my-1 leading-none uppercase tracking-widest border-b pb-2 flex justify-between font-semibold">
      ...
      @for ($i = 0; $i < $count; $i++)
        @if((int)$results[$i]['status'] % 10 == 1)
          <tr>
            @auth
              ...
              <td class="font-bold rounded-lg border border-white bg-purple-200 text-purple-700" > <a title="Go to Profile" href="{{route('user.profile', ['user' => $results[$i]['driver']['user_id']])}}"><i class="fas fa-user pr-2"></i></a> <a class="popOverBtn hover:underline cursor-pointer" onmouseout="openPopoverOut(event,'popover-id_{{$results[$i]['driver']['id']}}')" onmouseover="openPopover(event,'popover-id_{{$results[$i]['driver']['id']}}')">{{$results[$i]['driver']['name']}}</a>
        ...
        <tr>
            ...
            @endif
            @if ($results[$i]['driver']['user_id'] == Auth::id())
             <td class="font-bold rounded-lg border border-white bg-gray-700 text-white" > <a title="Go to Profile" href="{{route('user.profile', ['user' => $results[$i]['driver']['user_id']])}}"><i class="fas fa-user pr-2"></i></a> <a class="popOverBtn hover:underline cursor-pointer" onmouseout="openPopoverOut(event,'popover-id_{{$results[$i]['driver']['id']}}')" onmouseover="openPopover(event,'popover-id_{{$results[$i]['driver']['id']}}')">{{$results[$i]['driver']['name']}}</a>
              <!-- <button class="popOverBtn float-right text-gray p-1 mr-2 font-bold uppercase text-sm rounded outline-none focus:outline-none ease-linear transition-all duration-150" type="button" ><i class="fas fa-info-circle"></i> -->
              <!-- </button> -->
              <div class="insidePopDiv hidden shadow-lg bg-gray-500 border-0 mb-3 block z-50 font-normal leading-normal text-sm max-w-xs text-left no-underline break-words rounded-lg border" id="popover-id_{{$results[$i]['driver']['id']}}">
                <div>
            ...
            @else
             <td class="font-bold rounded-lg border border-white bg-gray-200" > <a title="Go to Profile" href="{{route('user.profile', ['user' => $results[$i]['driver']['user_id']])}}"><i class="fas fa-user pr-2"></i></a> <a class="popOverBtn hover:underline cursor-pointer" onmouseout="openPopoverOut(event,'popover-id_{{$results[$i]['driver']['id']}}')"  onmouseover="openPopover(event,'popover-id_{{$results[$i]['driver']['id']}}')">{{$results[$i]['driver']['name']}}</a> 
              <!-- <button class="popOverBtn float-right text-gray p-1 mr-2 font-bold uppercase text-sm rounded outline-none focus:outline-none ease-linear transition-all duration-150" type="button" ><i class="fas fa-info-circle"></i> -->
              <!-- </button> -->
              <div class="insidePopDiv hidden shadow-lg bg-gray-500 border-0 mb-3 block z-50 font-normal leading-normal text-sm max-w-xs text-left no-underline break-words rounded-lg border" id="popover-id_{{$results[$i]['driver']['id']}}">
                <div>
        ...
        @else
            ...
            @else
              <td class="font-bold rounded-lg border border-white" > <a title="Go to Profile" href="{{route('user.profile', ['user' => $results[$i]['driver']['user_id']])}}"><i class="fas fa-user pr-2"></i></a> <a class="popOverBtn hover:underline cursor-pointer" onmouseout="openPopoverOut(event,'popover-id_{{$results[$i]['driver']['id']}}')" onmouseover="openPopover(event,'popover-id_{{$results[$i]['driver']['id']}}')">{{$results[$i]['driver']['name']}}</a>
                <!-- <button class="popOverBtn float-right text-gray p-1 mr-2 font-bold uppercase text-sm rounded outline-none focus:outline-none ease-linear transition-all duration-150" type="button" ><i class="fas fa-info-circle"></i> -->
                <!-- </button> -->
                <div class="insidePopDiv hidden shadow-lg bg-gray-500 border-0 mb-3 block z-50 font-normal leading-normal text-sm max-w-xs text-left no-underline break-words rounded-lg border" id="popover-id_{{$results[$i]['driver']['id']}}">
                  <div>
