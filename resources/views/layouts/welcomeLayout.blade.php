        ...
        <div class="flex"  style="z-index: 4;">
            <div class="sidebar hidden fixed h-screen bg-gray-100 border w-56 py-4 px-4 shadow" id="sidebar">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="/f1leaguerules" class="px-3 py-2 font-semibold hover:bg-gray-300 hover:text-blue-600 rounded-md text-gray-700"><i class="text-indigo-600 fa fa-gavel w-8 text-center"></i>PC F1 League Rules </a>
                    <a href="/f1XBOXleaguerules" class="px-3 py-2 font-semibold hover:bg-gray-300 hover:text-blue-600 rounded-md text-gray-700"><i class="text-indigo-600 fa fa-gavel w-8 text-center"></i>XBOX F1 League Rules </a>
