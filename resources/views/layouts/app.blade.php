                ...
                <div class="h-screen py-2 text-black">
                    ...
                    <div>
                        <div class="my-8" id="main-menu">
                            ...
                            <div class="my-1">
                                <a href="/IRC_Rules__Regs_V7.pdf" target="_blank" class="py-2 text-black cursor-pointer pr-4 mx-4 rounded-md hover:bg-gray-900 font-medium hover:text-white flex items-center"><div class="items-center flex-shrink-0 w-12 text-center"><i class="fas fa-desktop"></i></div>F1</a>
