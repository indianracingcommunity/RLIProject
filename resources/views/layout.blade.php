      ...
      <nav class="flex justify-between border-b">
         <div class="flex py-2">
               <div class="px-3 bg-gray-800 mx-2 text-white font-bold rounded-md hover:bg-gray-700 cursor-pointer">
                  <a href="{{route('home')}}"   class="flex" class="px-3 bg-gray-800 mx-2 text-white font-bold rounded-md hover:bg-gray-700"><img src="/storage/img/IRC_logo/logo_square.png" class="h-10 mt-1"> <span class="p-3">Indian Racing Comunity</span> </a>
               </div>
